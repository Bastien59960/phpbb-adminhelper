...
$lang = array_merge($lang, [
    ...
    'ACP_ADMINHELPER_LOG_COL_SELECT' => 'Auswahl',
    'ACP_ADMINHELPER_ACTION_RESTORE_NOTIFY' => 'Benachrichtigungen wiederherstellen',
    'ACP_ADMINHELPER_ACTION_DELETE_SELECTED' => 'Auswahl loeschen',
    'ACP_ADMINHELPER_ACTION_DELETE_ALL' => 'Alle Zeilen loeschen',
    'ACP_ADMINHELPER_ACTION_NONE' => '-',
    'ACP_ADMINHELPER_SELECT_ALL' => 'Alles auswaehlen',
    'ACP_ADMINHELPER_UNSELECT_ALL' => 'Alles abwaehlen',
    'ACP_ADMINHELPER_DELETE_SELECTED_CONFIRM' => 'Ausgewaehlte Log-Zeilen loeschen?',
    'ACP_ADMINHELPER_DELETE_ALL_CONFIRM' => 'Alle Log-Zeilen loeschen?',
    'ACP_ADMINHELPER_DELETE_NONE_SELECTED' => 'Keine Log-Zeile ausgewaehlt.',
    'ACP_ADMINHELPER_DELETE_SELECTED_SUCCESS' => '%d Log-Zeile(n) geloescht.',
    'ACP_ADMINHELPER_DELETE_ALL_SUCCESS' => 'Log geleert (%d Zeile(n) geloescht).',
